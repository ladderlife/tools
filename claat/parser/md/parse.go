...
func renderToHTML(b []byte) ([]byte, error) {
	b = convertImports(b)
	gmParser := goldmark.New(goldmark.WithRendererOptions(gmhtml.WithUnsafe()), goldmark.WithExtensions(extension.Typographer, extension.Table, extension.DefinitionList, extension.Strikethrough, extension.Linkify))
